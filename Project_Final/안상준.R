...
#########################################################################################################################################################
result <- data.frame(price.xgb1, price.xgb2, price.xgb3, price.xgb4, price.xgb5, price.xgb6, price.rf1, price.rf2, price.rf3, price.rf4, price.rf5, price.rf6)
entire.ensemble <- apply(result, 1, mean)
#########################################################################################################################################################
